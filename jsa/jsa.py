...
# 📌 Extraer y limpiar los nombres de hojas desde la columna J (columna 9 en Python)
...
for hoja, info in datos_hojas.items():
    ...
    print(info["datos"].columns)  # Muestra las primeras filas de cada hoja, import pandas as pd
