...
file_path = "consolidado.xlsx"  # Ajusta con la ruta correcta
...
# Filtrar filas donde la columna B (índice 1) o E (índice 4) contengan "Recaudos"
df_filtrado = df[df.iloc[:, [1, 4]].astype(str).apply(lambda x: x.str.contains("Recaudos", case=False, na=False)).any(axis=1)]
...
df_filtrado.to_excel("filtrado_recaudos.xlsx", index=False)
